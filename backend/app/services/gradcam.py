...
class GradCAM:
    ...
    Fonctionne avec ResNet50 — cible la dernière couche conv (layer4)
    """
    ...
    def _register_hooks(self, layer_name: str):
        ...
        # Chercher la couche dans backbone (ResNet50)
        target = None
        for name, module in self.model.named_modules():
            if name == f"backbone.{layer_name}" or name == layer_name:
                target = module
                break
