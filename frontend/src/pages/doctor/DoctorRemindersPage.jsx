// frontend/src/pages/doctor/DoctorRemindersPage.jsx
import { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { useReminders } from "../../hooks/useReminders";
import { PatientIcons } from "../../constants/patientIcons"; // ou DoctorIcons
import { useDoctorReminders } from "../../hooks/useDoctorReminders";  // ← NOUVEAU

const DoctorRemindersPage = () => {
  const {
    reminders,
    loading,
    upcoming,
  ...
  return (
    <div style={{ background: "var(--bg, #F0F4FA)", minHeight: "100%", paddingBottom: 40 }}>
      {/* PAS DE HEADER - le parent (DoctorDashboard) l'a déjà */}
